      ...
      <main className="about-main">
        ...
        <section className="about-row">
          <div className="about-image">
            <img src="/about-1.png" className="about-mascot" />
          </div>
          <div className="about-box about-green-box">
            <h2>Our Vision</h2>
        ...
        <section className="about-row">
          <div className="about-box about-dark-box">
            <h2>Our Values</h2>
            <ul>
          ...
          <div className="about-image">
            <img src="/about-2.png" className="about-mascot" />
          </div>
        </section>

        <section className="about-row">
          <div className="about-image">
            <img src="/about-3.png" alt="Innovation" className="about-mascot" />
          </div>
          <div className="about-box about-green-box">
